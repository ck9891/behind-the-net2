...
ENV DATABASE_URL=postgresql://postgres.bokgyinuhjslwfwkjmfa:cXpmVXMnoHilxX7L@aws-0-ca-central-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1
ENV DIRECT_URL="postgresql://postgres.bokgyinuhjslwfwkjmfa:cXpmVXMnoHilxX7L@aws-0-ca-central-1.pooler.supabase.com:5432/postgres"
